...
public class SingleChoiceDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // NOTE: setMessage doesn't work here because the list takes up the content area.
        // Use the setTitle method to set a descriptive prompt
        ...
        // Single-choice dialogs don't need buttons because they auto-dismiss when the user makes a choice
